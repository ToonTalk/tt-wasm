...
boolean Visible_Background::display_region() {
  ...
  { static int n = 0; if (n < 3) { n++; printf("[tt] >> Visible_Background::display_region\n"); fflush(stdout); } }
#endif
   return(FALSE);
...
#ifdef __EMSCRIPTEN__
  { static int n = 0; if (n < 30) { n++; printf("[tt] >> Titles_Background::display_region this=%p idx=%d (frame=%ld)\n", (void*)this, (int)return_background_index(), (long)tt_frame_number); fflush(stdout); } }
#endif
