...
void Truck_Inside::java(java_stream &out) {
	...
	if (is_blank() || contained_in(THOUGHT_BUBBLE)) {
		...
		java_new(out,S(IDS_JAVA_TT_TRUCK),(Sprite *) NULL,(Sprite *) NULL,(Sprite *) NULL,(Sprite *) NULL,(Sprite *) NULL,(Sprite *) NULL,(Sprite *) NULL,by); // "this" added on 150201 - updated to "by" on 180201; bare NULLs cast to Sprite* to disambiguate java_new overload
	} else {
