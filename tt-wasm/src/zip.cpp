...
// WASM port: the original absolute DynaZip paths ("C:\Program Files\DynaZip Max
// 5.0\...") are replaced with bare includes that resolve to the opaque shim
// stubs (shim/dunzdll.h, shim/dzipdll.h). The static-lib branch is inactive
// (TT_DYNA_ZIP_STATIC undefined) so its headers aren't stubbed.
