...
void add_to_output(string narrow_text, wide_string &output) {
	...
	// following rewritten on 050705 since did the wrong thing with non-ASCII characters -- e.g. bili�es
...
//			if (tt_language != BRAZILIAN_PORTUGUESE) { // condition new on 040500
			...
			// somehow Brazilian Portuguese was recorded with - as nothing (e.g. ajud�-lo as ajud�lo)
