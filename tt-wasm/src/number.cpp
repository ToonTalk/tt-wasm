...
#include "number_old_display.cpp"
...
//				LongNumberValue keystroke((value >= 0)?key-'0':'0'-key);
				LongNumberValue keystroke((value >= (NumberValue *) 0)?digit_value:base-digit_value); // value is a pointer; (>= 0) kept as an ordered pointer compare to preserve the original (always-true) MSVC behavior
				if (sign() < 0) {
