...
var ASM_CONSTS = {
 ...
 17077409: ($0) => { globalThis.TT_engineReplaying = ($0 !== 0); },  
 17077457: ($0) => { if (globalThis.TT_demoPause) globalThis.TT_demoPause($0); },  
 17077519: () => { return globalThis.TT_presents|0; },  
 17077556: ($0, $1) => { try { localStorage.setItem('tt_walk',$0+','+Math.round($1)); } catch (e) {} },  
 17077636: () => { if (typeof location === 'undefined') return -1; var m = location.search.match(/[?&]citybudget=(d+)/); return m ? (m[1]|0) : -1; }
};
