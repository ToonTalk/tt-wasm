...
// include: C:\Users\toont\dev\tt-wasm\.tmp\tmpoe3d4ybv.js
...
// end include: C:\Users\toont\dev\tt-wasm\.tmp\tmpoe3d4ybv.js
// include: C:\Users\toont\dev\tt-wasm\.tmp\tmpv7a5qsci.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\toont\dev\tt-wasm\.tmp\tmpv7a5qsci.js
// include: shim/pre.js
...
// include: C:\Users\toont\dev\tt-wasm\.tmp\tmpjl_72jns.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\toont\dev\tt-wasm\.tmp\tmpjl_72jns.js
...
var ASM_CONSTS = {
  17077108: ($0, $1) => { if (globalThis.TT_engineFailed) globalThis.TT_engineFailed(UTF8ToString($0), UTF8ToString($1)); },  
 17077208: ($0, $1, $2, $3) => { if (typeof TT_present === 'function') TT_present($0, $1, $2, $3); },  
 17077278: ($0) => { var s = (typeof TT_cmdline === 'string') ? TT_cmdline : ''; if (s) stringToUTF8(s, $0, 1023); },  
 17077376: () => { globalThis.TT_replayOver = true; if (globalThis.TT_setMouseModeForUser) globalThis.TT_setMouseModeForUser(); },  
 17077489: ($0) => { globalThis.TT_timeTravelActive = ($0 !== 0); if ($0 && document.pointerLockElement) document.exitPointerLock(); },  
 17077605: () => { return (typeof location !== 'undefined' && location.search.indexOf('wand=1') >= 0) ? 1 : 0; },  
 17077701: () => { return (typeof location !== 'undefined' && location.search.indexOf('textpad=1') >= 0) ? 1 : 0; },  
 17077800: () => { return (typeof location !== 'undefined' && location.search.indexOf('padlong=1') >= 0) ? 1 : 0; },  
 17077899: () => { return (typeof location !== 'undefined' && location.search.indexOf('fraction=1') >= 0) ? 1 : 0; },  
 17077999: () => { var m = (typeof location !== 'undefined') && location.search.match(/fflags=([01])([01])([01])/); return m ? (16 + (m[1]|0)*4 + (m[2]|0)*2 + (m[3]|0)) : -1; },  
 17078159: () => { if (typeof location === 'undefined') return 0; var m = location.search.match(/fracexp=([0-9]+)/); if (m) return parseInt(m[1]); return location.search.indexOf('fracbig=1') >= 0 ? 100 : 0; },  
 17078351: () => { setTimeout(function() { Module._tt_frac_apply_pow(); }, 3500); },  
 17078418: () => { return (typeof location !== 'undefined' && location.search.indexOf('copyrobots=1') >= 0) ? 1 : 0; },  
 17078520: () => { var m = (typeof location !== 'undefined') ? location.search.match(new RegExp('robotpage=([0-9]+)')) : null; return m ? parseInt(m[1]) : 2; },  
 17078663: () => { return (typeof location !== 'undefined' && location.search.indexOf('runrobot=1') >= 0) ? 1 : 0; },  
 17078763: () => { var m = (typeof location !== 'undefined') ? location.search.match(new RegExp('subpage=([0-9]+)')) : null; return m ? parseInt(m[1]) : 0; },  
 17078904: () => { if (globalThis.TT_persistSave) globalThis.TT_persistSave('history'); },  
 17078977: () => { return (typeof location !== 'undefined' && /[?&]probes=1/.test(location.search)) ? 1 : 0; },  
 17079071: () => { return (typeof location !== 'undefined' && /[?&]floor=1/.test(location.search)) ? 1 : 0; },  
 17079164: () => { if (globalThis.TT_leaveDemo) globalThis.TT_leaveDemo(); },  
 17079224: ($0) => { globalThis.TT_engineReplaying = ($0 !== 0); },  
 17079272: ($0) => { if (globalThis.TT_demoPause) globalThis.TT_demoPause($0); },  
 17079334: () => { return globalThis.TT_presents|0; },  
 17079371: ($0, $1) => { try { localStorage.setItem('tt_walk',$0+','+Math.round($1)); } catch (e) {} },  
 17079451: () => { if (typeof location === 'undefined') return -1; var m = location.search.match(/[?&]citybudget=(d+)/); return m ? (m[1]|0) : -1; }
};
