...
// include: C:\Users\toont\dev\tt-wasm\.tmp\tmpro_wqgag.js
...
// end include: C:\Users\toont\dev\tt-wasm\.tmp\tmpro_wqgag.js
// include: C:\Users\toont\dev\tt-wasm\.tmp\tmp391dzjzh.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\toont\dev\tt-wasm\.tmp\tmp391dzjzh.js
// include: shim/pre.js
...
// include: C:\Users\toont\dev\tt-wasm\.tmp\tmp76nkdwn7.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\toont\dev\tt-wasm\.tmp\tmp76nkdwn7.js
...
var ASM_CONSTS = {
 ...
 17077749: ($0) => { var n = globalThis.TT_pendingLoad; if (!n || !(new RegExp('^[A-Za-z0-9_.-]+$')).test(n)) return 0; stringToUTF8(n, $0, 60); return 1; },  
 17077887: () => { return (typeof location !== 'undefined' && location.search.indexOf('wand=1') >= 0) ? 1 : 0; },  
 17077983: () => { return (typeof location !== 'undefined' && location.search.indexOf('textpad=1') >= 0) ? 1 : 0; },  
 17078082: () => { return (typeof location !== 'undefined' && location.search.indexOf('padlong=1') >= 0) ? 1 : 0; },  
 17078181: () => { return (typeof location !== 'undefined' && location.search.indexOf('fraction=1') >= 0) ? 1 : 0; },  
 17078281: () => { var m = (typeof location !== 'undefined') && location.search.match(/fflags=([01])([01])([01])/); return m ? (16 + (m[1]|0)*4 + (m[2]|0)*2 + (m[3]|0)) : -1; },  
 17078441: () => { if (typeof location === 'undefined') return 0; var m = location.search.match(/fracexp=([0-9]+)/); if (m) return parseInt(m[1]); return location.search.indexOf('fracbig=1') >= 0 ? 100 : 0; },  
 17078633: () => { setTimeout(function() { Module._tt_frac_apply_pow(); }, 3500); },  
 17078700: ($0) => { if (typeof location === 'undefined') return 0; var m = location.search.match(new RegExp('ttfile=([A-Za-z0-9_.-]+)')); if (!m) return 0; stringToUTF8('/toontalk/infinity/' + m[1] + '.tt', $0, 150); return 1; },  
 17078911: () => { return (typeof location !== 'undefined' && location.search.indexOf('copyrobots=1') >= 0) ? 1 : 0; },  
 17079013: () => { var m = (typeof location !== 'undefined') ? location.search.match(new RegExp('robotpage=([0-9]+)')) : null; return m ? parseInt(m[1]) : 2; },  
 17079156: () => { return (typeof location !== 'undefined' && location.search.indexOf('runrobot=1') >= 0) ? 1 : 0; },  
 17079256: () => { var m = (typeof location !== 'undefined') ? location.search.match(new RegExp('subpage=([0-9]+)')) : null; return m ? parseInt(m[1]) : 0; },  
 17079397: () => { if (globalThis.TT_persistSave) globalThis.TT_persistSave('history'); },  
 17079470: () => { return (typeof location !== 'undefined' && /[?&]probes=1/.test(location.search)) ? 1 : 0; },  
 17079564: () => { return (typeof location !== 'undefined' && /[?&]floor=1/.test(location.search)) ? 1 : 0; },  
 17079657: () => { if (globalThis.TT_leaveDemo) globalThis.TT_leaveDemo(); },  
 17079717: ($0) => { globalThis.TT_engineReplaying = ($0 !== 0); },  
 17079765: ($0) => { if (globalThis.TT_demoPause) globalThis.TT_demoPause($0); },  
 17079827: () => { return globalThis.TT_presents|0; },  
 17079864: ($0, $1) => { try { localStorage.setItem('tt_walk',$0+','+Math.round($1)); } catch (e) {} },  
 17079944: () => { if (typeof location === 'undefined') return -1; var m = location.search.match(/[?&]citybudget=(d+)/); return m ? (m[1]|0) : -1; }
};
...
var _tt_load_pending_file = Module['_tt_load_pending_file'] = makeInvalidEarlyAccess('_tt_load_pending_file');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['tt_load_pending_file'] != 'undefined', 'missing Wasm export: tt_load_pending_file');
  ...
  _tt_load_pending_file = Module['_tt_load_pending_file'] = createExportWrapper('tt_load_pending_file', 0);
